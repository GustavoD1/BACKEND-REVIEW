...
const ReviewController = {
  ...
  async create (req, res) {
    ...
    newReview.customerId = req.params.customerId // usuario actualmente autenticado
    newReview.restaurantId = req.params.restaurantId // ID del restaurante de la ruta
    try {
  ...
  async update (req, res) {
    try {
      await Review.update(req.body, { where: { id: req.params.reviewId, restaurantId: req.params.restaurantId } })
